DrawEllipse. C Tutorials. Visual Studio IDE. Windows API. 2D Graphics. GDI. DialogBased GUI Application. 
...
DrawEllipse. Занятия по C. ИС Microsoft Visual Studio. Windows API. 2D Графика. GDI. 
